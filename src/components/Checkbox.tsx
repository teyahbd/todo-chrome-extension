      ...
      <label>
        <input
          ...
          className={classNames(
            "appearance-none outline-none block relative text-center cursor-pointer m-auto before:rounded-sm before:block before:absolute before:content-[''] before:rounded-sm before:border-black after:block after:content-[''] after:absolute after:border-black after:origin-center after:rotate-45",
            {
            ...
            {
              "hover:bg-yellow-200 hover:checked:bg-yellow-300":
                color === "yellow",
            },
            {
